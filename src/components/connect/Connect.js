...
export const Connect = ({ authUser, dbUser }) => {
  ...
  return (
    <div className="connect" data-testid="connect">
      ...
      {connectStatus === "CONNECTED" && <p>You've successfully connected your Stripe account! Head back to the <Link to={ROUTES.DASHBOARD}>Dashboard</Link> to create your first product.</p>}
    </div>
  )
}
